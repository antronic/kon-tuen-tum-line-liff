...
<main class="bg-yellow-50">
  ...
  <div class="bg-gradient-to-br from-yellow-500 to-amber-400 flex py-64">
    <div class="pl-8 container mx-auto relative">
      ...
      <a href="#" class="inline-flex items-center group mt-4 bg-amber-700 hover:bg-amber-600 active:bg-amber-800 active:scale-95 active:shadow-sm transition-all shadow-md text-amber-100 px-4 py-2 text-lg rounded-md prompt-medium">
        ดูกิจกรรมเพิ่มเติม <Icon icon="mingcute:arrows-right-fill" class="group-hover:translate-x-1 group-active:translate-x-3 transition-transform inline-block" width="24" />
      </a>
    </div>
