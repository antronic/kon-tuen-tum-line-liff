...
<main class="bg-yellow-50">
  <nav class="bg-yellow-500 border-b border-yellow-400 text-white px-4 py-2 prompt-light">
  ...
  <div class="bg-gradient-to-br from-yellow-500 to-amber-400 flex py-64">
    <div class="pl-8 container mx-auto relative">
      <h1 class="text-yellow-700 prompt-medium">สวัสดีทุกท่าน<br/>ผู้รักในการหาทำ{import.meta.env.VITE_LIFF_ID}</h1>
      ...
      <a href="#" class="inline-flex items-center group mt-4 bg-green-500 hover:bg-green-600 active:bg-green-800 active:scale-95 active:shadow-sm transition-all shadow-md text-amber-100 px-4 py-2 text-lg rounded-md prompt-medium">
        เข้าสู่ระบบด้วย LINE เพื่อร่วมแสวงบุญ <Icon icon="mingcute:arrows-right-fill" class="group-hover:translate-x-1 group-active:translate-x-3 transition-transform inline-block" width="24" />
      </a>
    </div>
  ...
  <div class="py-4">
    <div class="text-center text-slate-800">
      ...
      <p>คำโปรย คำโปรย คำโปรย คำโปรย <span class="animate-pulse">✨✨</span></p>
    </div>
  </div>

  <div class="grid grid-cols-12 gap-x-8 px-8 container mx-auto pt-4 pb-16">
    <!-- Start region - Card -->
    <div class="group col-span-12 md:col-span-6 lg:col-span-4 bg-amber-100 rounded-lg overflow-clip hover:shadow-xl shadow-md transition-shadow">
    ...
    <!-- End region - Card -->
    <!-- Start region - Card -->
    <div class="col-span-12 md:col-span-6 lg:col-span-4 bg-amber-100 rounded-lg overflow-clip hover:shadow-xl shadow-md transition-shadow flex items-center">
      <div class="">
        <div class="p-4">
